    ...
    <div className="list">
      ...
      <div className="listContainer">
        ...
        <div className="btnConatiner">
         ...
         <Link to="/track" className="addbtn">Add Track</Link>          
        </div>
        <table className="tableContainer">
          ...
          {trackData.map((trac)=>{
            ...
            <tr key={trac.track_id} className="tr">
                ...
                <td onClick={()=>setArtistId(trac.track_id)} className="tbDButtn">delete</td>
                <td onClick={()=>setArtistId(trac.track_id)} className="tbUButton">update</td>
              </tr> 
